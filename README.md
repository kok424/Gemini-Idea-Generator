...
<p align="center">
  <img src="docs/screen1.png" width="300" alt="チャット画面">
  <img src="docs/screen2.png" width="300" alt="メニュー画面">
</p>

## 📖 概要
Googleの生成AIモデル「Gemini 1.5 Flash」を活用した、Android向けアイデア出し支援アプリです。
...
* **履歴の自動保存:** Room Databaseを使用し、アプリを閉じても過去のアイデアが消えない設計。
